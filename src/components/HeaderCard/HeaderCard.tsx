import { ArrowUturnLeftIcon, SignalIcon } from "@heroicons/react/20/solid";
...
export const HeaderCardWithZeroState = ({ eventState: liveEventState }: HeaderCardWithZeroStateProps) => {
  ...
  return (
    <div className={styles.marginWrapper}>
      <HeaderCard raceDetails={liveEventState.data} />
    </div>
  );
};
...
const HeaderCard = ({ raceDetails }: HeaderCardProps) => {
